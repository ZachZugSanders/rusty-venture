...
static DENY_UNIVERSAL: &[DenyEntry] = &[
    DenyEntry::new(
        ...
        "Remove .env and add it to .gitignore. Use .env.example for templates.",
    ),
    DenyEntry::new(
        ".env.local",
        ViolationSeverity::Critical,
        "Remove .env.local — it may contain local secrets.",
    ),
    DenyEntry::new(
        ".env.production",
        ViolationSeverity::Critical,
        "Remove .env.production — NEVER commit production credentials.",
    ),
    DenyEntry::new(
        ".env.staging",
        ViolationSeverity::Critical,
        "Remove .env.staging — NEVER commit environment credentials.",
    ),
    DenyEntry::new(
        "*.pem",
        ViolationSeverity::Critical,
        "Remove certificate file and rotate any exposed keys immediately.",
    ),
    DenyEntry::new(
        "*.key",
        ViolationSeverity::Critical,
        "Remove private key file and rotate the key immediately.",
    ),
    DenyEntry::new(
        "*.p12",
        ViolationSeverity::Critical,
        "Remove PKCS#12 certificate bundle.",
    ),
    DenyEntry::new(
        "*.pfx",
        ViolationSeverity::Critical,
        "Remove PFX certificate file.",
    ),
    DenyEntry::new(
        "id_rsa",
        ViolationSeverity::Critical,
        "Remove SSH private key and rotate it immediately.",
    ),
    DenyEntry::new(
        "id_ed25519",
        ViolationSeverity::Critical,
    ...
    DenyEntry::new(
        "*.ppk",
        ViolationSeverity::Critical,
        "Remove PuTTY private key file.",
    ),
    DenyEntry::new(
        "credentials.json",
        ViolationSeverity::Critical,
        "Remove credentials file — may contain API keys or OAuth tokens.",
    ),
    DenyEntry::new(
        "secrets.yaml",
        ViolationSeverity::Critical,
        "Remove secrets file — add to .gitignore.",
    ),
    DenyEntry::new(
        "secrets.yml",
        ViolationSeverity::Critical,
    ...
    DenyEntry::new(
        ...
        "Remove macOS metadata file and add .DS_Store to .gitignore.",
    ),
    DenyEntry::new(
        "Thumbs.db",
        ViolationSeverity::Info,
        "Remove Windows thumbnail cache and add to .gitignore.",
    ),
    DenyEntry::new(
        "*.log",
        ViolationSeverity::Warning,
        "Remove log files and add *.log to .gitignore.",
    ),
    DenyEntry::new(
        "*.tmp",
        ViolationSeverity::Info,
        "Remove temp files and add *.tmp to .gitignore.",
    ),
    DenyEntry::new(
        "*.bak",
        ViolationSeverity::Info,
        "Remove backup files and add *.bak to .gitignore.",
    ),
    DenyEntry::new(
        "*.swp",
        ViolationSeverity::Info,
        "Remove Vim swap file and add *.swp to .gitignore.",
    ),
    DenyEntry::new(
        "*.orig",
        ViolationSeverity::Info,
        "Remove .orig conflict resolution file.",
    ),
];
...
static DENY_RUST: &[DenyEntry] = &[
    DenyEntry::new(
        "target/",
        ViolationSeverity::Warning,
        "Remove the target/ build directory — it should be in .gitignore.",
    ),
    DenyEntry::new(
        "*.rs.bk",
        ViolationSeverity::Info,
        "Remove rustfmt backup files and add *.rs.bk to .gitignore.",
    ),
    DenyEntry::new(
        "*.pdb",
        ViolationSeverity::Info,
        "Remove Windows debug symbol files.",
    ),
];
...
static DENY_PYTHON: &[DenyEntry] = &[
    ...
    DenyEntry::new(
        "*.pyc",
        ViolationSeverity::Warning,
        "Remove compiled Python files and add *.pyc to .gitignore.",
    ),
    DenyEntry::new(
        "*.pyo",
        ViolationSeverity::Warning,
        "Remove optimized Python files.",
    ),
    DenyEntry::new(
        ".venv/",
        ViolationSeverity::Critical,
        "Remove .venv/ virtual environment — add to .gitignore.",
    ),
    DenyEntry::new(
        "venv/",
        ViolationSeverity::Critical,
    ...
    DenyEntry::new(
        ".pytest_cache/",
        ViolationSeverity::Info,
        "Remove pytest cache — add to .gitignore.",
    ),
    DenyEntry::new(
        ".mypy_cache/",
        ViolationSeverity::Info,
        "Remove mypy cache — add to .gitignore.",
    ),
    DenyEntry::new(
        ".ruff_cache/",
        ViolationSeverity::Info,
        "Remove ruff cache — add to .gitignore.",
    ),
    DenyEntry::new(
        "*.egg-info/",
        ViolationSeverity::Warning,
        "Remove egg-info directory — add to .gitignore.",
    ),
    DenyEntry::new(
        "dist/",
        ViolationSeverity::Warning,
        "Remove Python dist/ build output.",
    ),
];
...
static DENY_GO: &[DenyEntry] = &[
    DenyEntry::new(
        "vendor/",
        ViolationSeverity::Warning,
        "Consider whether vendor/ should be committed. Use Go modules instead.",
    ),
    DenyEntry::new(
        "bin/",
        ViolationSeverity::Warning,
        "Remove compiled Go binaries from the repository.",
    ),
];
...
static DENY_JAVA: &[DenyEntry] = &[
    DenyEntry::new(
        "target/",
        ViolationSeverity::Warning,
        "Remove Maven target/ directory — add to .gitignore.",
    ),
    DenyEntry::new(
        "*.class",
        ViolationSeverity::Warning,
        "Remove compiled .class files — add to .gitignore.",
    ),
    DenyEntry::new(
        "*.jar",
        ViolationSeverity::Warning,
        "Remove JAR files from source control — use a package manager.",
    ),
    DenyEntry::new(
        "*.war",
        ViolationSeverity::Warning,
        "Remove WAR files from source control.",
    ),
    DenyEntry::new(
        "build/",
        ViolationSeverity::Warning,
        "Remove Gradle build/ output — add to .gitignore.",
    ),
    DenyEntry::new(
        ".gradle/",
        ViolationSeverity::Warning,
        "Remove .gradle/ cache — add to .gitignore.",
    ),
];
...
static DENY_RUBY: &[DenyEntry] = &[
    DenyEntry::new(
        ".bundle/",
        ViolationSeverity::Warning,
        "Remove .bundle/ config — add to .gitignore.",
    ),
    DenyEntry::new(
        "*.gem",
        ViolationSeverity::Warning,
        "Remove built gem files from source control.",
    ),
    DenyEntry::new(
        ".byebug_history",
        ViolationSeverity::Info,
        "Remove Byebug history — add to .gitignore.",
    ),
];
...
static DENY_PHP: &[DenyEntry] = &[
    DenyEntry::new(
        "vendor/",
        ViolationSeverity::Critical,
        "Remove vendor/ — it should be installed via Composer, not committed.",
    ),
    DenyEntry::new(
        "storage/",
        ViolationSeverity::Warning,
        "Laravel storage/ should generally not be committed.",
    ),
    DenyEntry::new(
        "bootstrap/cache/",
        ViolationSeverity::Warning,
        "Remove bootstrap/cache/ — add to .gitignore.",
    ),
];
...
static DENY_CSHARP: &[DenyEntry] = &[
    DenyEntry::new(
        "bin/",
        ViolationSeverity::Warning,
        "Remove bin/ build output — add to .gitignore.",
    ),
    DenyEntry::new(
        "obj/",
        ViolationSeverity::Warning,
        "Remove obj/ build output — add to .gitignore.",
    ),
    DenyEntry::new(
        ".vs/",
        ViolationSeverity::Info,
        "Remove .vs/ Visual Studio cache — add to .gitignore.",
    ),
    DenyEntry::new(
        "*.nupkg",
        ViolationSeverity::Warning,
        "Remove NuGet packages — use a package feed instead.",
    ),
    DenyEntry::new(
        "TestResults/",
        ViolationSeverity::Info,
        "Remove test results directory — add to .gitignore.",
    ),
];
...
impl Action for AuditCommittedFilesAction {
    ...
    async fn execute(&self, ctx: &ExecutionContext, _input: ()) -> Result<AuditReport, CoreError> {
        ...
        let find_result = exec_in_container(
            ...
            &container_id,
            ExecCommand::new([
                "find", &repo_path, "-not", "-path", "*/.git/*", "-type", "f",
            ]),
        )
        .await?;

        let tracked_files: Vec<String> = ls_result
            .stdout
            .lines()
        ...
        let all_files: Vec<String> = find_result
            .stdout
            .lines()
            .filter(|l| !l.trim().is_empty())
            .map(|l| {
                l.strip_prefix(&format!("{repo_path}/"))
                    .unwrap_or(l)
                    .to_string()
            })
            .collect();
